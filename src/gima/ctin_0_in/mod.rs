...
impl SELECTR {
    ...
    pub fn _from(value: u8) -> SELECTR {
        match value {
            0 => SELECTR::CTIN_0,
            1 => SELECTR::SGPIO3,
            2 => SELECTR::SGPIO3_DIV,
            i => SELECTR::_Reserved(i),
        }
    }
    #[doc = "Checks if the value of the field is `CTIN_0`"]
    #[inline]
    pub fn is_ctin_0(&self) -> bool {
        *self == SELECTR::CTIN_0
    }
...
impl<'a> _SELECTW<'a> {
    ...
    #[doc = "CTIN_0"]
    #[inline]
    pub fn ctin_0(self) -> &'a mut W {
        self.variant(SELECTW::CTIN_0)
    }
    #[doc = "SGPIO3"]
    #[inline]
