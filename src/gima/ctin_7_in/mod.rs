...
pub enum SELECTR {
    #[doc = "CTIN_7"]
    CTIN_7,
    #[doc = "USART3 RX active"]
    USART3_RX_ACTIVE,
    #[doc = "SOF0 (Start-Of-Frame USB0)"]
    SOF0_START_OF_FRAME,
    #[doc = "SOF1 (Start-Of-Frame USB1)"]
    SOF1_START_OF_FRAME,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
impl SELECTR {
    ...
    pub fn bits(&self) -> u8 {
        match *self {
            SELECTR::CTIN_7 => 0,
            SELECTR::USART3_RX_ACTIVE => 1,
            SELECTR::SOF0_START_OF_FRAME => 2,
            SELECTR::SOF1_START_OF_FRAME => 3,
    ...
    pub fn _from(value: u8) -> SELECTR {
        match value {
            0 => SELECTR::CTIN_7,
            1 => SELECTR::USART3_RX_ACTIVE,
            2 => SELECTR::SOF0_START_OF_FRAME,
            3 => SELECTR::SOF1_START_OF_FRAME,
            i => SELECTR::_Reserved(i),
        }
    }
    #[doc = "Checks if the value of the field is `CTIN_7`"]
    #[inline]
    pub fn is_ctin_7(&self) -> bool {
        *self == SELECTR::CTIN_7
    }
    #[doc = "Checks if the value of the field is `USART3_RX_ACTIVE`"]
    #[inline]
    pub fn is_usart3_rx_active(&self) -> bool {
        *self == SELECTR::USART3_RX_ACTIVE
    }
    #[doc = "Checks if the value of the field is `SOF0_START_OF_FRAME`"]
    #[inline]
    pub fn is_sof0_start_of_frame(&self) -> bool {
        *self == SELECTR::SOF0_START_OF_FRAME
    }
    #[doc = "Checks if the value of the field is `SOF1_START_OF_FRAME`"]
    #[inline]
    pub fn is_sof1_start_of_frame(&self) -> bool {
        *self == SELECTR::SOF1_START_OF_FRAME
    }
}
...
impl SELECTW {
    ...
    pub fn _bits(&self) -> u8 {
        match *self {
            SELECTW::CTIN_7 => 0,
            SELECTW::USART3_RX_ACTIVE => 1,
            SELECTW::SOF0_START_OF_FRAME => 2,
            SELECTW::SOF1_START_OF_FRAME => 3,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _SELECTW<'a> {
    ...
    #[doc = "CTIN_7"]
    #[inline]
    pub fn ctin_7(self) -> &'a mut W {
        self.variant(SELECTW::CTIN_7)
    }
    #[doc = "USART3 RX active"]
    #[inline]
    pub fn usart3_rx_active(self) -> &'a mut W {
        self.variant(SELECTW::USART3_RX_ACTIVE)
    }
    #[doc = "SOF0 (Start-Of-Frame USB0)"]
    #[inline]
    pub fn sof0_start_of_frame(self) -> &'a mut W {
        self.variant(SELECTW::SOF0_START_OF_FRAME)
    }
    #[doc = "SOF1 (Start-Of-Frame USB1)"]
    #[inline]
    pub fn sof1_start_of_frame(self) -> &'a mut W {
        self.variant(SELECTW::SOF1_START_OF_FRAME)
    }
    #[doc = r" Writes raw bits to the field"]
    #[inline]
...
impl R {
    ...
    #[doc = "Bits 4:7 - Select input. Values 0x4 to 0xF are reserved."]
    #[inline]
