...
impl SELECTR {
    ...
    pub fn _from(value: u8) -> SELECTR {
        match value {
            0 => SELECTR::CTIN_2,
            1 => SELECTR::SGPIO3_DIV,
            2 => SELECTR::T0_CAP2,
            i => SELECTR::_Reserved(i),
        }
    }
    #[doc = "Checks if the value of the field is `CTIN_2`"]
    #[inline]
    pub fn is_ctin_2(&self) -> bool {
        *self == SELECTR::CTIN_2
    }
    #[doc = "Checks if the value of the field is `SGPIO3_DIV`"]
    #[inline]
    pub fn is_sgpio3_div(&self) -> bool {
        *self == SELECTR::SGPIO3_DIV
    }
    #[doc = "Checks if the value of the field is `T0_CAP2`"]
    #[inline]
    pub fn is_t0_cap2(&self) -> bool {
        *self == SELECTR::T0_CAP2
    }
}
...
impl<'a> _SELECTW<'a> {
    ...
    #[doc = "CTIN_2"]
    #[inline]
    pub fn ctin_2(self) -> &'a mut W {
        self.variant(SELECTW::CTIN_2)
    }
    #[doc = "SGPIO3_DIV"]
    #[inline]
    pub fn sgpio3_div(self) -> &'a mut W {
        self.variant(SELECTW::SGPIO3_DIV)
    }
    #[doc = "T0_CAP2"]
    #[inline]
    pub fn t0_cap2(self) -> &'a mut W {
        self.variant(SELECTW::T0_CAP2)
    }
    #[doc = r" Writes raw bits to the field"]
    #[inline]
