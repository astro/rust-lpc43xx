...
impl SELECTR {
    ...
    pub fn bits(&self) -> u8 {
        match *self {
            SELECTR::CTIN_5 => 0,
            SELECTR::USART2_RX_ACTIVE => 1,
            SELECTR::_I2S1_TX_MWS => 2,
            SELECTR::T2_CAP2 => 3,
    ...
    pub fn _from(value: u8) -> SELECTR {
        match value {
            0 => SELECTR::CTIN_5,
            1 => SELECTR::USART2_RX_ACTIVE,
            2 => SELECTR::_I2S1_TX_MWS,
            3 => SELECTR::T2_CAP2,
            i => SELECTR::_Reserved(i),
        }
    }
    #[doc = "Checks if the value of the field is `CTIN_5`"]
    #[inline]
    pub fn is_ctin_5(&self) -> bool {
        *self == SELECTR::CTIN_5
    }
    #[doc = "Checks if the value of the field is `USART2_RX_ACTIVE`"]
    #[inline]
    pub fn is_usart2_rx_active(&self) -> bool {
        *self == SELECTR::USART2_RX_ACTIVE
    }
    #[doc = "Checks if the value of the field is `_I2S1_TX_MWS`"]
    #[inline]
    pub fn is_i2s1_tx_mws(&self) -> bool {
        *self == SELECTR::_I2S1_TX_MWS
    }
    #[doc = "Checks if the value of the field is `T2_CAP2`"]
    #[inline]
    pub fn is_t2_cap2(&self) -> bool {
        *self == SELECTR::T2_CAP2
    }
}
...
impl SELECTW {
    ...
    pub fn _bits(&self) -> u8 {
        match *self {
            SELECTW::CTIN_5 => 0,
            SELECTW::USART2_RX_ACTIVE => 1,
            SELECTW::_I2S1_TX_MWS => 2,
            SELECTW::T2_CAP2 => 3,
        }
    }
}
...
impl<'a> _SELECTW<'a> {
    ...
    #[doc = "CTIN_5"]
    #[inline]
    pub fn ctin_5(self) -> &'a mut W {
        self.variant(SELECTW::CTIN_5)
    }
    #[doc = "USART2 RX active"]
    #[inline]
    pub fn usart2_rx_active(self) -> &'a mut W {
        self.variant(SELECTW::USART2_RX_ACTIVE)
    }
    #[doc = "- I2S1_TX_MWS"]
    #[inline]
    pub fn _i2s1_tx_mws(self) -> &'a mut W {
        self.variant(SELECTW::_I2S1_TX_MWS)
    }
    #[doc = "T2_CAP2"]
    #[inline]
    pub fn t2_cap2(self) -> &'a mut W {
        self.variant(SELECTW::T2_CAP2)
    }
    #[doc = r" Writes raw bits to the field"]
    #[inline]
