...
impl SELECTR {
    ...
    #[doc = "Checks if the value of the field is `I2S1_RX_MWS`"]
    #[inline]
    pub fn is_i2s1_rx_mws(&self) -> bool {
        *self == SELECTR::I2S1_RX_MWS
    }
...
impl<'a> _SELECTW<'a> {
    ...
    #[doc = "- I2S1_RX_MWS"]
    #[inline]
    pub fn i2s1_rx_mws(self) -> &'a mut W {
        self.variant(SELECTW::I2S1_RX_MWS)
    }
    #[doc = "T2_CAP1"]
    #[inline]
