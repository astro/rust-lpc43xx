...
impl SELECTR {
    ...
    pub fn bits(&self) -> u8 {
        match *self {
            SELECTR::CTIN_1 => 0,
            SELECTR::USART2_TX_ACTIVE => 1,
            SELECTR::_I2S1_RX_MWS => 2,
            SELECTR::T2_CAP1 => 3,
    ...
    pub fn _from(value: u8) -> SELECTR {
        match value {
            0 => SELECTR::CTIN_1,
            1 => SELECTR::USART2_TX_ACTIVE,
            2 => SELECTR::_I2S1_RX_MWS,
            3 => SELECTR::T2_CAP1,
            i => SELECTR::_Reserved(i),
        }
    }
    #[doc = "Checks if the value of the field is `CTIN_1`"]
    #[inline]
    pub fn is_ctin_1(&self) -> bool {
        *self == SELECTR::CTIN_1
    }
    #[doc = "Checks if the value of the field is `USART2_TX_ACTIVE`"]
    #[inline]
    pub fn is_usart2_tx_active(&self) -> bool {
        *self == SELECTR::USART2_TX_ACTIVE
    }
    #[doc = "Checks if the value of the field is `_I2S1_RX_MWS`"]
    #[inline]
    pub fn is_i2s1_rx_mws(&self) -> bool {
        *self == SELECTR::_I2S1_RX_MWS
    }
    #[doc = "Checks if the value of the field is `T2_CAP1`"]
    #[inline]
    pub fn is_t2_cap1(&self) -> bool {
        *self == SELECTR::T2_CAP1
    }
}
...
impl SELECTW {
    ...
    pub fn _bits(&self) -> u8 {
        match *self {
            SELECTW::CTIN_1 => 0,
            SELECTW::USART2_TX_ACTIVE => 1,
            SELECTW::_I2S1_RX_MWS => 2,
            SELECTW::T2_CAP1 => 3,
        }
    }
}
...
impl<'a> _SELECTW<'a> {
    ...
    #[doc = "CTIN_1"]
    #[inline]
    pub fn ctin_1(self) -> &'a mut W {
        self.variant(SELECTW::CTIN_1)
    }
    #[doc = "USART2 TX active"]
    #[inline]
    pub fn usart2_tx_active(self) -> &'a mut W {
        self.variant(SELECTW::USART2_TX_ACTIVE)
    }
    #[doc = "- I2S1_RX_MWS"]
    #[inline]
    pub fn _i2s1_rx_mws(self) -> &'a mut W {
        self.variant(SELECTW::_I2S1_RX_MWS)
    }
    #[doc = "T2_CAP1"]
    #[inline]
    pub fn t2_cap1(self) -> &'a mut W {
        self.variant(SELECTW::T2_CAP1)
    }
    #[doc = r" Writes raw bits to the field"]
    #[inline]
