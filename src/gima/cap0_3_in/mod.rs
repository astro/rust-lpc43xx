...
impl SELECTR {
    ...
    #[doc = "Checks if the value of the field is `T0_CAP3`"]
    #[inline]
    pub fn is_t0_cap3(&self) -> bool {
        *self == SELECTR::T0_CAP3
    }
    #[doc = "Checks if the value of the field is `T3_MAT3`"]
    #[inline]
    pub fn is_t3_mat3(&self) -> bool {
        *self == SELECTR::T3_MAT3
    }
}
...
impl<'a> _SELECTW<'a> {
    ...
    #[doc = "T0_CAP3"]
    #[inline]
    pub fn t0_cap3(self) -> &'a mut W {
        self.variant(SELECTW::T0_CAP3)
    }
    #[doc = "T3_MAT3"]
    #[inline]
    pub fn t3_mat3(self) -> &'a mut W {
        self.variant(SELECTW::T3_MAT3)
    }
    #[doc = r" Writes raw bits to the field"]
    #[inline]
