...
impl SELECTR {
    ...
    #[doc = "Checks if the value of the field is `T3_CAP2`"]
    #[inline]
    pub fn is_t3_cap2(&self) -> bool {
        *self == SELECTR::T3_CAP2
    }
}
...
impl<'a> _SELECTW<'a> {
    ...
    #[doc = "T3_CAP2"]
    #[inline]
    pub fn t3_cap2(self) -> &'a mut W {
        self.variant(SELECTW::T3_CAP2)
    }
    #[doc = r" Writes raw bits to the field"]
    #[inline]
