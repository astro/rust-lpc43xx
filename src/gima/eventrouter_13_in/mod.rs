...
impl SELECTR {
    ...
    pub fn _from(value: u8) -> SELECTR {
        match value {
            0 => SELECTR::CTOUT_2_OR_T0_MAT2,
            1 => SELECTR::SGPIO3,
            2 => SELECTR::T0_MAT2,
            i => SELECTR::_Reserved(i),
        }
    }
    #[doc = "Checks if the value of the field is `CTOUT_2_OR_T0_MAT2`"]
    #[inline]
    pub fn is_ctout_2_or_t0_mat2(&self) -> bool {
        *self == SELECTR::CTOUT_2_OR_T0_MAT2
    }
    #[doc = "Checks if the value of the field is `SGPIO3`"]
    #[inline]
    pub fn is_sgpio3(&self) -> bool {
        *self == SELECTR::SGPIO3
    }
    #[doc = "Checks if the value of the field is `T0_MAT2`"]
    #[inline]
    pub fn is_t0_mat2(&self) -> bool {
        *self == SELECTR::T0_MAT2
    }
}
...
impl<'a> _SELECTW<'a> {
    ...
    #[doc = "CTOUT_2 or T0_MAT2"]
    #[inline]
    pub fn ctout_2_or_t0_mat2(self) -> &'a mut W {
        self.variant(SELECTW::CTOUT_2_OR_T0_MAT2)
    }
    #[doc = "SGPIO3"]
    #[inline]
    pub fn sgpio3(self) -> &'a mut W {
        self.variant(SELECTW::SGPIO3)
    }
    #[doc = "T0_MAT2"]
    #[inline]
    pub fn t0_mat2(self) -> &'a mut W {
        self.variant(SELECTW::T0_MAT2)
    }
    #[doc = r" Writes raw bits to the field"]
    #[inline]
