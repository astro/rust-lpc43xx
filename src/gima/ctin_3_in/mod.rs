...
impl SELECTR {
    ...
    pub fn _from(value: u8) -> SELECTR {
        match value {
            0 => SELECTR::CTIN_3,
            1 => SELECTR::USART0_TX_ACTIVE,
            i => SELECTR::_Reserved(i),
        }
    }
    #[doc = "Checks if the value of the field is `CTIN_3`"]
    #[inline]
    pub fn is_ctin_3(&self) -> bool {
        *self == SELECTR::CTIN_3
    }
    #[doc = "Checks if the value of the field is `USART0_TX_ACTIVE`"]
    #[inline]
    pub fn is_usart0_tx_active(&self) -> bool {
        *self == SELECTR::USART0_TX_ACTIVE
    }
}
...
impl<'a> _SELECTW<'a> {
    ...
    #[doc = "CTIN_3"]
    #[inline]
    pub fn ctin_3(self) -> &'a mut W {
        self.variant(SELECTW::CTIN_3)
    }
    #[doc = "USART0 TX active"]
    #[inline]
    pub fn usart0_tx_active(self) -> &'a mut W {
        self.variant(SELECTW::USART0_TX_ACTIVE)
    }
    #[doc = r" Writes raw bits to the field"]
    #[inline]
