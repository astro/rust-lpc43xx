...
impl SELECTR {
    ...
    pub fn bits(&self) -> u8 {
        match *self {
            ...
            SELECTR::I2S0_RX_MWS => 2,
            SELECTR::I2S0_TX_MWS => 3,
    ...
    pub fn _from(value: u8) -> SELECTR {
        match value {
            ...
            2 => SELECTR::I2S0_RX_MWS,
            3 => SELECTR::I2S0_TX_MWS,
            i => SELECTR::_Reserved(i),
        }
    }
    #[doc = "Checks if the value of the field is `CTIN_6`"]
    #[inline]
    pub fn is_ctin_6(&self) -> bool {
        *self == SELECTR::CTIN_6
    }
    #[doc = "Checks if the value of the field is `USART3_TX_ACTIVE`"]
    #[inline]
    pub fn is_usart3_tx_active(&self) -> bool {
        *self == SELECTR::USART3_TX_ACTIVE
    }
    #[doc = "Checks if the value of the field is `I2S0_RX_MWS`"]
    #[inline]
    pub fn is_i2s0_rx_mws(&self) -> bool {
        *self == SELECTR::I2S0_RX_MWS
    }
    #[doc = "Checks if the value of the field is `I2S0_TX_MWS`"]
    #[inline]
    pub fn is_i2s0_tx_mws(&self) -> bool {
        *self == SELECTR::I2S0_TX_MWS
    }
}
...
impl SELECTW {
    ...
    pub fn _bits(&self) -> u8 {
        match *self {
            ...
            SELECTW::I2S0_RX_MWS => 2,
            SELECTW::I2S0_TX_MWS => 3,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _SELECTW<'a> {
    ...
    #[doc = "CTIN_6"]
    #[inline]
    pub fn ctin_6(self) -> &'a mut W {
        self.variant(SELECTW::CTIN_6)
    }
    #[doc = "USART3 TX active"]
    #[inline]
    pub fn usart3_tx_active(self) -> &'a mut W {
        self.variant(SELECTW::USART3_TX_ACTIVE)
    }
    #[doc = "I2S0_RX_MWS"]
    #[inline]
    pub fn i2s0_rx_mws(self) -> &'a mut W {
        self.variant(SELECTW::I2S0_RX_MWS)
    }
    #[doc = "I2S0_TX_MWS"]
    #[inline]
    pub fn i2s0_tx_mws(self) -> &'a mut W {
        self.variant(SELECTW::I2S0_TX_MWS)
    }
    #[doc = r" Writes raw bits to the field"]
    #[inline]
