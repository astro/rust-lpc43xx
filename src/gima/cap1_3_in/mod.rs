...
impl SELECTR {
    ...
    pub fn _from(value: u8) -> SELECTR {
        match value {
            0 => SELECTR::CTOUT_3_OR_T0_MAT3,
            1 => SELECTR::T1_CAP3,
            2 => SELECTR::T0_MAT3,
            i => SELECTR::_Reserved(i),
        }
    }
    #[doc = "Checks if the value of the field is `CTOUT_3_OR_T0_MAT3`"]
    #[inline]
    pub fn is_ctout_3_or_t0_mat3(&self) -> bool {
        *self == SELECTR::CTOUT_3_OR_T0_MAT3
    }
    #[doc = "Checks if the value of the field is `T1_CAP3`"]
    #[inline]
    pub fn is_t1_cap3(&self) -> bool {
        *self == SELECTR::T1_CAP3
    }
    #[doc = "Checks if the value of the field is `T0_MAT3`"]
    #[inline]
    pub fn is_t0_mat3(&self) -> bool {
        *self == SELECTR::T0_MAT3
    }
}
...
impl<'a> _SELECTW<'a> {
    ...
    #[doc = "CTOUT_3 or T0_MAT3"]
    #[inline]
    pub fn ctout_3_or_t0_mat3(self) -> &'a mut W {
        self.variant(SELECTW::CTOUT_3_OR_T0_MAT3)
    }
    #[doc = "T1_CAP3"]
    #[inline]
    pub fn t1_cap3(self) -> &'a mut W {
        self.variant(SELECTW::T1_CAP3)
    }
    #[doc = "T0_MAT3"]
    #[inline]
    pub fn t0_mat3(self) -> &'a mut W {
        self.variant(SELECTW::T0_MAT3)
    }
    #[doc = r" Writes raw bits to the field"]
    #[inline]
