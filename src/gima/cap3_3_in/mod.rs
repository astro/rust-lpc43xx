...
impl SELECTR {
    ...
    pub fn bits(&self) -> u8 {
        match *self {
            SELECTR::CTOUT11_OR_T2_MAT3 => 0,
            SELECTR::SOF1_START_OF_FRAME => 1,
            SELECTR::T3_CAP3 => 2,
            SELECTR::T2_MAT3 => 3,
    ...
    pub fn _from(value: u8) -> SELECTR {
        match value {
            0 => SELECTR::CTOUT11_OR_T2_MAT3,
            1 => SELECTR::SOF1_START_OF_FRAME,
            2 => SELECTR::T3_CAP3,
            3 => SELECTR::T2_MAT3,
            i => SELECTR::_Reserved(i),
        }
    }
    #[doc = "Checks if the value of the field is `CTOUT11_OR_T2_MAT3`"]
    #[inline]
    pub fn is_ctout11_or_t2_mat3(&self) -> bool {
        *self == SELECTR::CTOUT11_OR_T2_MAT3
    }
    ...
    #[doc = "Checks if the value of the field is `T3_CAP3`"]
    #[inline]
    pub fn is_t3_cap3(&self) -> bool {
        *self == SELECTR::T3_CAP3
    }
    #[doc = "Checks if the value of the field is `T2_MAT3`"]
    #[inline]
    pub fn is_t2_mat3(&self) -> bool {
        *self == SELECTR::T2_MAT3
    }
}
...
impl SELECTW {
    ...
    pub fn _bits(&self) -> u8 {
        match *self {
            SELECTW::CTOUT11_OR_T2_MAT3 => 0,
            SELECTW::SOF1_START_OF_FRAME => 1,
            SELECTW::T3_CAP3 => 2,
            SELECTW::T2_MAT3 => 3,
        }
    }
...
impl<'a> _SELECTW<'a> {
    ...
    #[doc = "CTOUT11 or T2_MAT3"]
    #[inline]
    pub fn ctout11_or_t2_mat3(self) -> &'a mut W {
        self.variant(SELECTW::CTOUT11_OR_T2_MAT3)
    }
    #[doc = "SOF1 (Start-Of-Frame USB1)"]
    #[inline]
    ...
    #[doc = "T3_CAP3"]
    #[inline]
    pub fn t3_cap3(self) -> &'a mut W {
        self.variant(SELECTW::T3_CAP3)
    }
    #[doc = "T2_MAT3"]
    #[inline]
    pub fn t2_mat3(self) -> &'a mut W {
        self.variant(SELECTW::T2_MAT3)
    }
    #[doc = r" Writes raw bits to the field"]
    #[inline]
