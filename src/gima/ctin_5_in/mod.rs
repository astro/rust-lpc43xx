...
impl SELECTR {
    ...
    #[doc = "Checks if the value of the field is `SGPIO12_DIV`"]
    #[inline]
    pub fn is_sgpio12_div(&self) -> bool {
        *self == SELECTR::SGPIO12_DIV
    }
}
...
impl<'a> _SELECTW<'a> {
    ...
    #[doc = "SGPIO12_DIV"]
    #[inline]
    pub fn sgpio12_div(self) -> &'a mut W {
        self.variant(SELECTW::SGPIO12_DIV)
    }
    #[doc = r" Writes raw bits to the field"]
    #[inline]
