...
impl SELECTR {
    ...
    pub fn _from(value: u8) -> SELECTR {
        match value {
            0 => SELECTR::CTOUT_6_OR_T1_MAT2,
            1 => SELECTR::SGPIO12,
            2 => SELECTR::T1_MAT2,
            i => SELECTR::_Reserved(i),
        }
    }
    #[doc = "Checks if the value of the field is `CTOUT_6_OR_T1_MAT2`"]
    #[inline]
    pub fn is_ctout_6_or_t1_mat2(&self) -> bool {
        *self == SELECTR::CTOUT_6_OR_T1_MAT2
    }
...
impl<'a> _SELECTW<'a> {
    ...
    #[doc = "CTOUT_6 or T1_MAT2"]
    #[inline]
    pub fn ctout_6_or_t1_mat2(self) -> &'a mut W {
        self.variant(SELECTW::CTOUT_6_OR_T1_MAT2)
    }
    #[doc = "SGPIO12"]
    #[inline]
