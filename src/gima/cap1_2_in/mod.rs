...
impl SELECTR {
    ...
    #[doc = "Checks if the value of the field is `CTIN_4`"]
    #[inline]
    pub fn is_ctin_4(&self) -> bool {
        *self == SELECTR::CTIN_4
    }
    #[doc = "Checks if the value of the field is `USART0_RX_ACTIVE`"]
    #[inline]
    pub fn is_usart0_rx_active(&self) -> bool {
        *self == SELECTR::USART0_RX_ACTIVE
    }
    #[doc = "Checks if the value of the field is `T1_CAP2`"]
    #[inline]
    pub fn is_t1_cap2(&self) -> bool {
        *self == SELECTR::T1_CAP2
    }
}
...
impl<'a> _SELECTW<'a> {
    ...
    #[doc = "CTIN_4"]
    #[inline]
    pub fn ctin_4(self) -> &'a mut W {
        self.variant(SELECTW::CTIN_4)
    }
    #[doc = "USART0 RX active"]
    #[inline]
    pub fn usart0_rx_active(self) -> &'a mut W {
        self.variant(SELECTW::USART0_RX_ACTIVE)
    }
    #[doc = "T1_CAP2"]
    #[inline]
    pub fn t1_cap2(self) -> &'a mut W {
        self.variant(SELECTW::T1_CAP2)
    }
    #[doc = r" Writes raw bits to the field"]
    #[inline]
