...
impl CMR {
    ...
    pub fn bits(&self) -> u8 {
        match *self {
            CMR::IDLE => 0,
            CMR::DEVICE_CONTROLLER => 2,
            CMR::HOST_CONTROLLER => 3,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    ...
    pub fn _from(value: u8) -> CMR {
        match value {
            0 => CMR::IDLE,
            2 => CMR::DEVICE_CONTROLLER,
            3 => CMR::HOST_CONTROLLER,
            _ => unreachable!(),
        }
    }
...
impl CMW {
    ...
    pub fn _bits(&self) -> u8 {
        match *self {
            CMW::IDLE => 0,
            CMW::DEVICE_CONTROLLER => 2,
            CMW::HOST_CONTROLLER => 3,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _CMW<'a> {
    ...
    pub fn idle(self) -> &'a mut W {
        self.variant(CMW::IDLE)
    }
    #[doc = "Device controller"]
    #[inline]
    pub fn device_controller(self) -> &'a mut W {
        self.variant(CMW::DEVICE_CONTROLLER)
    }
    #[doc = "Host controller"]
    #[inline]
    pub fn host_controller(self) -> &'a mut W {
        self.variant(CMW::HOST_CONTROLLER)
    }
