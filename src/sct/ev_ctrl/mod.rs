...
pub enum HEVENTR {
    #[doc = "L state. Selects the L state and the L match register selected by MATCHSEL."]
    L_STATE,
    #[doc = "H state. Selects the H state and the H match register selected by MATCHSEL."]
    H_STATE,
}
impl HEVENTR {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            HEVENTR::L_STATE => false,
            HEVENTR::H_STATE => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    ...
    pub fn _from(value: bool) -> HEVENTR {
        match value {
            false => HEVENTR::L_STATE,
            true => HEVENTR::H_STATE,
        }
    }
    #[doc = "Checks if the value of the field is `L_STATE`"]
    #[inline]
    pub fn is_l_state(&self) -> bool {
        *self == HEVENTR::L_STATE
    }
    #[doc = "Checks if the value of the field is `H_STATE`"]
    #[inline]
    pub fn is_h_state(&self) -> bool {
        *self == HEVENTR::H_STATE
    }
}
#[doc = "Possible values of the field `OUTSEL`"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum OUTSELR {
    #[doc = "Input. Selects the input selected by IOSEL."]
    INPUT,
    #[doc = "Output. Selects the output selected by IOSEL."]
    OUTPUT,
}
impl OUTSELR {
    #[doc = r" Returns `true` if the bit is clear (0)"]
...
impl HEVENTW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            HEVENTW::L_STATE => false,
            HEVENTW::H_STATE => true,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _HEVENTW<'a> {
    ...
    #[doc = "L state. Selects the L state and the L match register selected by MATCHSEL."]
    #[inline]
    pub fn l_state(self) -> &'a mut W {
        self.variant(HEVENTW::L_STATE)
    }
    #[doc = "H state. Selects the H state and the H match register selected by MATCHSEL."]
    #[inline]
    pub fn h_state(self) -> &'a mut W {
        self.variant(HEVENTW::H_STATE)
    }
