...
#[doc = r" Proxy"]
pub struct _ENA_EVENT0W<'a> {
    w: &'a mut W,
}
impl<'a> _ENA_EVENT0W<'a> {
...
#[doc = r" Proxy"]
pub struct _ENA_EVENT1W<'a> {
    w: &'a mut W,
}
impl<'a> _ENA_EVENT1W<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
