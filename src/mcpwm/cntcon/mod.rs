...
impl TC0MCI0_FER {
    ...
    pub fn _from(value: bool) -> TC0MCI0_FER {
        match value {
            false => TC0MCI0_FER::NOEFECT,
            true => TC0MCI0_FER::FALLING,
        }
    }
    #[doc = "Checks if the value of the field is `NOEFECT`"]
    #[inline]
    pub fn is_noefect(&self) -> bool {
        *self == TC0MCI0_FER::NOEFECT
    }
...
impl TC0MCI2_FER {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            TC0MCI2_FER::NOEFFECT => false,
            TC0MCI2_FER::FALLING => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    ...
    pub fn _from(value: bool) -> TC0MCI2_FER {
        match value {
            false => TC0MCI2_FER::NOEFFECT,
            true => TC0MCI2_FER::FALLING,
        }
    }
    #[doc = "Checks if the value of the field is `NOEFFECT`"]
    #[inline]
    pub fn is_noeffect(&self) -> bool {
        *self == TC0MCI2_FER::NOEFFECT
    }
    #[doc = "Checks if the value of the field is `FALLING`"]
    #[inline]
    pub fn is_falling(&self) -> bool {
        *self == TC0MCI2_FER::FALLING
    }
}
...
impl TC1MCI2_FER {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            TC1MCI2_FER::NOEFFECT => false,
            TC1MCI2_FER::RISING => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    ...
    pub fn _from(value: bool) -> TC1MCI2_FER {
        match value {
            false => TC1MCI2_FER::NOEFFECT,
            true => TC1MCI2_FER::RISING,
        }
    }
    #[doc = "Checks if the value of the field is `NOEFFECT`"]
    #[inline]
    pub fn is_noeffect(&self) -> bool {
        *self == TC1MCI2_FER::NOEFFECT
    }
    #[doc = "Checks if the value of the field is `RISING`"]
    #[inline]
    pub fn is_rising(&self) -> bool {
        *self == TC1MCI2_FER::RISING
    }
}
...
impl TC2MCI0_RER {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            TC2MCI0_RER::NOEFFECT => false,
            TC2MCI0_RER::FALLING => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    ...
    pub fn _from(value: bool) -> TC2MCI0_RER {
        match value {
            false => TC2MCI0_RER::NOEFFECT,
            true => TC2MCI0_RER::FALLING,
        }
    }
    #[doc = "Checks if the value of the field is `NOEFFECT`"]
    #[inline]
    pub fn is_noeffect(&self) -> bool {
        *self == TC2MCI0_RER::NOEFFECT
    }
    #[doc = "Checks if the value of the field is `FALLING`"]
    #[inline]
    pub fn is_falling(&self) -> bool {
        *self == TC2MCI0_RER::FALLING
    }
}
...
impl TC2MCI1_RER {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            TC2MCI1_RER::NOEFFECT => false,
            TC2MCI1_RER::FALLING => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    ...
    pub fn _from(value: bool) -> TC2MCI1_RER {
        match value {
            false => TC2MCI1_RER::NOEFFECT,
            true => TC2MCI1_RER::FALLING,
        }
    }
    #[doc = "Checks if the value of the field is `NOEFFECT`"]
    #[inline]
    pub fn is_noeffect(&self) -> bool {
        *self == TC2MCI1_RER::NOEFFECT
    }
    #[doc = "Checks if the value of the field is `FALLING`"]
    #[inline]
    pub fn is_falling(&self) -> bool {
        *self == TC2MCI1_RER::FALLING
    }
}
...
impl TC2MCI2_RER {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            TC2MCI2_RER::NOEFFECT => false,
            TC2MCI2_RER::FALLING => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    ...
    pub fn _from(value: bool) -> TC2MCI2_RER {
        match value {
            false => TC2MCI2_RER::NOEFFECT,
            true => TC2MCI2_RER::FALLING,
        }
    }
    #[doc = "Checks if the value of the field is `NOEFFECT`"]
    #[inline]
    pub fn is_noeffect(&self) -> bool {
        *self == TC2MCI2_RER::NOEFFECT
    }
    #[doc = "Checks if the value of the field is `FALLING`"]
    #[inline]
    pub fn is_falling(&self) -> bool {
        *self == TC2MCI2_RER::FALLING
    }
}
