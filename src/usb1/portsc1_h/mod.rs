...
impl HSPR {
    ...
    pub fn _from(value: bool) -> HSPR {
        match value {
            false => HSPR::NOHIGHSPEED,
            true => HSPR::HIGHSPEED,
        }
    }
    #[doc = "Checks if the value of the field is `NOHIGHSPEED`"]
    #[inline]
    pub fn is_nohighspeed(&self) -> bool {
        *self == HSPR::NOHIGHSPEED
    }
...
impl WKCNR {
    ...
    #[doc = "Checks if the value of the field is `ENABLE_DEVICE_CON`"]
    #[inline]
    pub fn is_enable_device_con(&self) -> bool {
        *self == WKCNR::ENABLE_DEVICE_CON
    }
}
...
impl WKOCR {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            WKOCR::DISABLES_OVERCURRENT => false,
            WKOCR::ENABLE_OVERCURRENT => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    ...
    pub fn _from(value: bool) -> WKOCR {
        match value {
            false => WKOCR::DISABLES_OVERCURRENT,
            true => WKOCR::ENABLE_OVERCURRENT,
        }
    }
    #[doc = "Checks if the value of the field is `DISABLES_OVERCURRENT`"]
    #[inline]
    pub fn is_disables_overcurrent(&self) -> bool {
        *self == WKOCR::DISABLES_OVERCURRENT
    }
    #[doc = "Checks if the value of the field is `ENABLE_OVERCURRENT`"]
    #[inline]
    pub fn is_enable_overcurrent(&self) -> bool {
        *self == WKOCR::ENABLE_OVERCURRENT
    }
}
...
impl PHCDR {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            PHCDR::ENABLE_PHY_CLK => false,
            PHCDR::DISABLE_PHY_CLK => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    ...
    pub fn _from(value: bool) -> PHCDR {
        match value {
            false => PHCDR::ENABLE_PHY_CLK,
            true => PHCDR::DISABLE_PHY_CLK,
        }
    }
    #[doc = "Checks if the value of the field is `ENABLE_PHY_CLK`"]
    #[inline]
    pub fn is_enable_phy_clk(&self) -> bool {
        *self == PHCDR::ENABLE_PHY_CLK
    }
    #[doc = "Checks if the value of the field is `DISABLE_PHY_CLK`"]
    #[inline]
    pub fn is_disable_phy_clk(&self) -> bool {
        *self == PHCDR::DISABLE_PHY_CLK
    }
}
...
impl<'a> _HSPW<'a> {
    ...
    #[doc = "Host/device connected to the port is not in High-speed mode."]
    #[inline]
    pub fn nohighspeed(self) -> &'a mut W {
        self.variant(HSPW::NOHIGHSPEED)
    }
    #[doc = "Host/device connected to the port is in High-speed mode."]
    #[inline]
...
impl WKOCW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            WKOCW::DISABLES_OVERCURRENT => false,
            WKOCW::ENABLE_OVERCURRENT => true,
        }
    }
}
#[doc = r" Proxy"]
...
impl PHCDW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            PHCDW::ENABLE_PHY_CLK => false,
            PHCDW::DISABLE_PHY_CLK => true,
        }
    }
}
#[doc = r" Proxy"]
