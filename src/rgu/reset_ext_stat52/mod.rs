...
pub struct PERIPHERAL_RESETR {
    bits: bool,
}
impl PERIPHERAL_RESETR {
...
#[doc = r" Proxy"]
pub struct _PERIPHERAL_RESETW<'a> {
    w: &'a mut W,
}
impl<'a> _PERIPHERAL_RESETW<'a> {
