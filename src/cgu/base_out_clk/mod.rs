...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum AUTOBLOCKR {
    #[doc = "Autoblocking disabled"]
    AUTOBLOCKING_DISABLE,
    #[doc = "Autoblocking enabled"]
...
impl AUTOBLOCKR {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            AUTOBLOCKR::AUTOBLOCKING_DISABLE => false,
            AUTOBLOCKR::AUTOBLOCKING_ENABLED => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    ...
    pub fn _from(value: bool) -> AUTOBLOCKR {
        match value {
            false => AUTOBLOCKR::AUTOBLOCKING_DISABLE,
            true => AUTOBLOCKR::AUTOBLOCKING_ENABLED,
        }
    }
    #[doc = "Checks if the value of the field is `AUTOBLOCKING_DISABLE`"]
    #[inline]
    pub fn is_autoblocking_disable(&self) -> bool {
        *self == AUTOBLOCKR::AUTOBLOCKING_DISABLE
    }
    #[doc = "Checks if the value of the field is `AUTOBLOCKING_ENABLED`"]
    #[inline]
    pub fn is_autoblocking_enabled(&self) -> bool {
        *self == AUTOBLOCKR::AUTOBLOCKING_ENABLED
    }
}
...
impl CLK_SELR {
    ...
    #[doc = "Checks if the value of the field is `PLL0_FOR_USB`"]
    #[inline]
    pub fn is_pll0_for_usb(&self) -> bool {
        *self == CLK_SELR::PLL0_FOR_USB
    }
...
impl AUTOBLOCKW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            AUTOBLOCKW::AUTOBLOCKING_DISABLE => false,
            AUTOBLOCKW::AUTOBLOCKING_ENABLED => true,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _AUTOBLOCKW<'a> {
    ...
    #[doc = "Autoblocking disabled"]
    #[inline]
    pub fn autoblocking_disable(self) -> &'a mut W {
        self.variant(AUTOBLOCKW::AUTOBLOCKING_DISABLE)
    }
    #[doc = "Autoblocking enabled"]
    #[inline]
    pub fn autoblocking_enabled(self) -> &'a mut W {
        self.variant(AUTOBLOCKW::AUTOBLOCKING_ENABLED)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl<'a> _CLK_SELW<'a> {
    ...
    #[doc = "PLL0 (for USB)"]
    #[inline]
    pub fn pll0_for_usb(self) -> &'a mut W {
        self.variant(CLK_SELW::PLL0_FOR_USB)
    }
    #[doc = "PLL0 (for audio)"]
    #[inline]
