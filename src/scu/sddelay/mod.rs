...
#[doc = r" Proxy"]
pub struct _SAMPLE_DELAYW<'a> {
    w: &'a mut W,
}
impl<'a> _SAMPLE_DELAYW<'a> {
...
#[doc = r" Proxy"]
pub struct _DRV_DELAYW<'a> {
    w: &'a mut W,
}
impl<'a> _DRV_DELAYW<'a> {
    #[doc = r" Writes raw bits to the field"]
    #[inline]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
        const MASK: u8 = 15;
...
impl R {
    ...
    #[doc = "Bits 0:3 - SD/MMC sample delay. The delay value is SAMPLE_DELAY x 0.5 ns."]
    #[inline]
    pub fn sample_delay(&self) -> SAMPLE_DELAYR {
        let bits = {
            const MASK: u8 = 15;
            const OFFSET: u8 = 0;
